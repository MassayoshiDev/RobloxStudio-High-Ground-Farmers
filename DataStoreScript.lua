-- Atualizei agora o código de DataStore.
-- Demorei um pouco pra atualizar o código aqui no GitHub mas não tem problema.

-- Vantagens do código antigo:
